...
export default function Board() {
  const showOnlyFirst = true; //! quick test to toggle...
  ...
  return (
    <div className="relative w-full flex justify-center">
      ...
      <img
        src={boardImg}
        alt="Board"
        className="w-full h-auto max-w-none border-4 border-red-500"
      />
      ...
      >
        ...
        >
          <Badge year="20171" character="dry-bones" margin="1pts" />
        </div>

        {/* All other badges - conditionally shown */}
        {!showOnlyFirst && (
          <>
            {/* 2019 */}
            <div
